...
<%
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" name="boardTitle" id="boardTitle" maxlength="50">
		</div>
		<div class="form-group">
		<label for="boardContents">글 내용</label>
		<textarea class="form-control" name="boardContents" id="boardContents" rows="10" cols="50" maxlength="500"></textarea>
		</div>
